...
def load_secure_repository():
    """Initializes persistent workforce and financial states with correct dates."""
    if 'workforce_matrix' not in st.session_state:
        st.session_state.workforce_matrix = pd.DataFrame([
            ...
            {"Date": "21/06/2026", "Employee ID": "79705332", "Name": "Abdul khaliq", "Company": "Rimal. AL", "Scope": "Civil", "Time In": "7:00 AM", "Time Out": "5:00 PM", "PPE": "Verified", "Status": "Present"},
            {"Date": "21/06/2026", "Employee ID": "91385467", "Name": "Murtuza", "Company": "Ahmed. AL", "Scope": "Civil", "Time In": "7:00 AM", "Time Out": "5:00 PM", "PPE": "Verified", "Status": "Present"}
        ])
